...
my $diag_call_history = <<"END";
    ...
    #     once() called at $FILE line 16
    #     twice() called at $FILE line 17
    #     twice() called at $FILE line 17
    #     thrice(1) called at $FILE line 18
    #     thrice(2) called at $FILE line 18
    #     thrice(3) called at $FILE line 18
END
...
subtest 'simple called_ok() that fails' => sub {
    my $test_name = 'one() was called 1 time(s)';
    my $line      = __LINE__ + 13;
...
subtest 'diagnostics with no method call history' => sub {
    my $new = mock;
    my $test_name = 'never_called() was called 1 time(s)';
    my $line      = __LINE__ + 14;
...
subtest 'called_ok() with invalid between() value (pair are not numbers)' => sub {
    like(
        exception {
...
subtest 'called_ok() with invalid between() value (pair not ordered)' => sub {
    like(
        my $e = exception {
...
subtest 'called_ok() in a TODO block' => sub {
    my $test_name = 'method_not_called() was called 1 time(s)';
    my $line      = __LINE__ + 14;
...
not ok 1 - $test_name # TODO should fail
    ...
    #   at $FILE line $line.
    # Error: unexpected number of calls to 'method_not_called()'
    #          got: 0 time(s)
    #     expected: 1 time(s)
$diag_call_history
OUT
